...
PMA_messages['strDropDatabaseStrongWarning'] = "Vous êtes sur le point de DETRUIRE une base de données !";
PMA_messages['strDropTableStrongWarning'] = "Vous êtes sur le point de DETRUIRE une table au complet !";
...
PMA_messages['strRefreshFailed'] = "Echec de rafraîchissement de la surveillance";
...
PMA_messages['strFailedParsingConfig'] = "Echec d\'analyse du fichier de configuration. Il ne contient pas de code JSON valide.";
PMA_messages['strFailedBuildingGrid'] = "Echec de construction du graphique avec la configuration importée. Réinitialisation à la configuration par défaut…";
...
PMA_messages['strRequestFailed'] = "Echec de cette requête !";
...
PMA_messages['strConfirmDeleteResults'] = "Supprimer de la table %s les occurences ?";
PMA_messages['MissingReturn'] = "La définition d\'une fonction doit comporter un énoncé RETURN !";
PMA_messages['strExport'] = "Export";
PMA_messages['NoExportable'] = "Aucune routine n’est exportable. Des privilèges requis manquent sans-doute.";
PMA_messages['enum_editor'] = "Editeur ENUM/SET";
...
PMA_messages['strMysqlAllowedValuesTipTime'] = "MySQL accepte des valeurs non sélectionnables via le menu; entrez directement ces valeurs si besoin";
PMA_messages['strMysqlAllowedValuesTipDate'] = "MySQL accepte des valeurs non sélectionnables via le sélecteur de date; entrez directement ces valeurs si besoin";
...
PMA_messages['dropImportMessageFailed'] = "Echec";
PMA_messages['dropImportMessageSuccess'] = "Succès";
PMA_messages['dropImportImportResultHeader'] = "Etat de l\'importation";
