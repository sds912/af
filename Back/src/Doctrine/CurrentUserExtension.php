...
class CurrentUserExtension implements QueryCollectionExtensionInterface,QueryItemExtensionInterface{//pour un get d une collection et le get d'un seul élément video 80 lior
    ...
    {//de l interface QueryCollectionExtensionInterface
        ...
        // if($resourceClass===User::class){ exemple
        ...
        //     $queryBuilder->andWhere("$rootAlias.nom= :nom")
        //     ->setParameter('nom', "Abdoulaye");//comme dans un query buider
        // }
    }
