 ...
 */
final class Version20201009124834 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE client (id INT AUTO_INCREMENT NOT NULL, denomination VARCHAR(255) NOT NULL, adresse VARCHAR(255) DEFAULT NULL, telephone VARCHAR(255) DEFAULT NULL, cle VARCHAR(255) DEFAULT NULL, nom_contact VARCHAR(255) DEFAULT NULL, tel_contact VARCHAR(255) DEFAULT NULL, date_creation DATE NOT NULL, base_hash VARCHAR(255) NOT NULL, image LONGTEXT DEFAULT NULL, nombre INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE immobilisation (id INT AUTO_INCREMENT NOT NULL, entreprise_id INT DEFAULT NULL, inventaire_id INT DEFAULT NULL, lecteur_id INT DEFAULT NULL, localite_id INT DEFAULT NULL, matched_immo_id INT DEFAULT NULL, ajusteur_id INT DEFAULT NULL, libelle VARCHAR(255) NOT NULL, code VARCHAR(255) DEFAULT NULL, compte_immo VARCHAR(255) DEFAULT NULL, compte_amort VARCHAR(255) DEFAULT NULL, emplacement VARCHAR(255) DEFAULT NULL, date_acquisition DATE DEFAULT NULL, date_mise_serv DATE DEFAULT NULL, date_sortie DATE DEFAULT NULL, duree_utilite VARCHAR(255) DEFAULT NULL, taux DOUBLE PRECISION DEFAULT NULL, val_origine DOUBLE PRECISION DEFAULT NULL, dotation DOUBLE PRECISION DEFAULT NULL, cumul_amortiss DOUBLE PRECISION DEFAULT NULL, vnc DOUBLE PRECISION DEFAULT NULL, etat VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, numero_ordre VARCHAR(255) DEFAULT NULL, end_etat VARCHAR(255) DEFAULT NULL, status VARCHAR(255) DEFAULT NULL, image LONGTEXT DEFAULT NULL, date_lecture DATETIME DEFAULT NULL, is_matched TINYINT(1) DEFAULT NULL, approv_status INT DEFAULT NULL, INDEX IDX_B1563E27A4AEAFEA (entreprise_id), INDEX IDX_B1563E27CE430A85 (inventaire_id), INDEX IDX_B1563E2749DB9E60 (lecteur_id), INDEX IDX_B1563E27924DD2B5 (localite_id), INDEX IDX_B1563E273C43260F (matched_immo_id), INDEX IDX_B1563E278DE90D1F (ajusteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
