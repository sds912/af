 ...
 */
final class Version20200906125249 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE immobilisation ADD inventaire_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE immobilisation DROP inventaire_id');
    }
}
